...
%         \caption{ Decay curve for the isomeric transition of \ce{^{113m}In}.}
    ...
    \end{subfigure}%
    \caption{Results of variance minimization through enhancement of the effective areal density of the 6061 aluminum degraders by 2.53\%. A noticeable reduction of variance in measured proton fluence is seen,  particularly at the  rear stack positions. The \enquote{extra fluence} observed in the  \ce{^{nat}Al}(p,x)\ce{^{22}Na} and \ce{^{nat}Cu}(p,x)\ce{^{56}Co} monitor channels is caused by activation through (n,x) reactions from the secondary neutron flux. By excluding these contaminated channels, the remaining 3 independent monitor reactions serve to minimize uncertainty in stack energy assignments and incident fluence.\comment{Lee: I think you should make the fonts ridiculously larger.  }}
...
\ce{^{51}Cr}\,($\sigma_c$)    & $0.888\pm0.058$         & $0.361\pm0.015$         & $0.440\pm0.019$         & $0.2949\pm0.0070$       & --\cmmnt{\hrulefill}              & --\cmmnt{\hrulefill}              \\
\ce{^{52}Mn}\,($\sigma_c$)    & $1.640\pm0.042$         & $0.552\pm0.014$         & $0.0398\pm0.0012$       & $0.00513\pm0.00051$     & --\cmmnt{\hrulefill}              & --\cmmnt{\hrulefill}              \\
\ce{^{52g}Mn}\,($\sigma_i$)   & $0.650\pm0.018$         & $0.231\pm0.013$         & $0.0160\pm0.0021$       & $0.000961\pm0.000027$   & --\cmmnt{\hrulefill}              & --\cmmnt{\hrulefill}              \\
\ce{^{52m}Mn}\,($\sigma_i$)   & $0.989\pm0.037$         & $0.321\pm0.020$         & $0.0238\pm0.0032$       & $0.00417\pm0.00043$     & --\cmmnt{\hrulefill}              & --\cmmnt{\hrulefill}              \\
\ce{^{54}Mn}\,($\sigma_c$)    & $5.67\pm0.15$           & $3.65\pm0.11$           & $4.05\pm0.11$           & $4.71\pm0.12$           & $1.656\pm0.042$         & --\cmmnt{\hrulefill}              \\
\ce{^{55}Co}\,($\sigma_c$)    & $1.656\pm0.048$         & $0.983\pm0.030$         & $0.1892\pm0.0076$       & $0.0291\pm0.0024$       & $0.00231\pm0.00019$     & --\cmmnt{\hrulefill}              \\
\ce{^{56}Ni}\,($\sigma_c$)    & $0.0779\pm0.0022$       & $0.0973\pm0.0025$       & $0.0886\pm0.0022$       & $0.02967\pm0.00079$     & --\cmmnt{\hrulefill}              & --\cmmnt{\hrulefill}              \\
...
E$_\text{p}$ (MeV)             & $89.74^{+0.48}_{-0.43}$ & $79.95^{+0.67}_{-0.64}$ & $70.17^{+0.91}_{-0.85}$ & $61.58^{+1.03}_{-0.98}$ & $52.10^{+1.25}_{-1.20}$ & $41.05^{+1.62}_{-1.54}$ \\ \midrule
\ce{^{nat}Cu}(p,x)\ce{^{52}Mn} & $0.603\pm0.027$         & $0.581\pm0.038$         & $0.598\pm0.083$         & $0.81\pm0.12$         & --\cmmnt{\hrulefill}              & --\cmmnt{\hrulefill}              \\
\ce{^{nat}Cu}(p,x)\ce{^{58}Co} & $0.757\pm0.068$         & $0.804\pm0.091$         & $0.858\pm0.084$         & $0.767\pm0.086$         & $0.82\pm0.11$         & $0.982\pm0.075$    \vspace{1em}     \\ 
E$_\text{p}$ (MeV)             & $89.37^{+0.47}_{-0.45}$ & $79.55^{+0.68}_{-0.64}$ & $69.70^{+0.90}_{-0.85}$ & $61.07^{+1.05}_{-0.98}$ & $51.51^{+1.25}_{-1.21}$ & $40.34^{+1.58}_{-1.55}$ \\ \midrule
\ce{^{nat}Nb}(p,x)\ce{^{85}Y}  & $0.828\pm0.029$         & $0.724\pm0.072$         & $0.736\pm0.072$         & --\cmmnt{\hrulefill}              & --\cmmnt{\hrulefill}              & --\cmmnt{\hrulefill}              \\
\ce{^{nat}Nb}(p,x)\ce{^{87}Y}  & $0.746\pm0.045$         & $0.865\pm0.036$         & $0.893\pm0.032$         & $0.936\pm0.038$         & $0.961\pm0.032$         & $0.676\pm0.040$         \\
\ce{^{nat}Nb}(p,x)\ce{^{89}Nb} & --\cmmnt{\hrulefill}              & --\cmmnt{\hrulefill}              & $0.193\pm0.018$         & $0.1304\pm0.0074$         &      --\cmmnt{\hrulefill}         & --\cmmnt{\hrulefill}              \\ \bottomrule
\end{tabular}
}
\end{table}
...
It also represents  the first measurement of the independent cross sections for    \ce{^{nat}Cu}(p,x)\ce{^{52\text{m}}Mn} ($2^+$) and  \ce{^{nat}Cu}(p,x)\ce{^{52\text{g}}Mn}  ($6^+$), as well as their  isomer branching ratio via \ce{^{nat}Cu}(p,x).  
...
Notably, this work serves as the most well-characterized measurement of the \ce{^{nat}Nb}(p,x)\ce{^{90}Mo} reaction below 100 MeV to date, with cross sections measured  at the 2-3\% uncertainty level.
...
This result presents the first step towards the use of \ce{^{90}Mo} as a clean and precise monitor for charged particle dosimetry in irradiations up to approximately 24 hours in duration.
...
In particular, it is highly desired to form a theranostic pair with the widely-employed $\beta^-$ therapy agent \ce{^{90}Y} ($t_{1/2}=64.00\pm0.21$ h, $\beta^-$=100\% to \ce{^{90}Zr} \cite{Browne1997}), which can be produced from a long-lived \ce{^{90}Sr} cow and emits no observable gamma-rays or x-rays though decay, necessitating an imaging isotope to be paired with for quantification of its uptake and biodistribution  \cite{Herzog1993}.
...
As a result, it would appear that \ce{^{nat}Nb}(p,x) is a poor route for  \ce{^{86}Y} production in this respect, as it only reaches a maximum of approximately 35\% of all radio-yttrium activities produced.
This is because the dominant radio-yttrium activity in 40-90 MeV \ce{^{nat}Nb}(p,x) is  \ce{^{87}Y}, the largest obstacle to high-specific activity production of  \ce{^{86}Y} due to the unnecessary patient dose it contributes,  its comparable half-life, and the fact that separation is impractical.
...
\ce{^{89}Zr} ($t_{1/2}=78.41\pm0.12$ h, $\epsilon$=100\% to \ce{^{89}Y}  \cite{Singh2013}) is a long-lived PET emitter, whose  lifetime makes it useful as a tracer for slow biological processes, immune studies, and imaging of liver and  breast cancers \cite{Verel2003,Dijkers2009,Dijkers2010}.
...
However, the greatest problem with using the \ce{^{nat}Nb}(p,x) reaction to produce \ce{^{90}Nb} is the inability to separate the radioisotope from the target itself, rendering the production of a high-specific activity target impossible.  
...
In summation, we present here a set of 38 measurements of cross sections for the \ce{^{nat}Nb}(p,x) and  \ce{^{nat}Cu}(p,x) reactions between 40--90 MeV, as well as 5 independent measurements of isomer branching ratios.
Nearly all cross sections have been reported with smaller uncertainties than previous measurements.
