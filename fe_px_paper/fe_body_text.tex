...
comparisons  of the
remaining measured cross sections and isomer branching ratios with modeling results and literature data (retrieved from EXFOR\,\cite{Otuka2014272}) are seen in the figures of 
% Appendices 
\ref{sec:fe_xs_figures} and \ref{sec:fe_ibr_figures}.
...
%         \caption{ Decay curve for the isomeric transition of \ce{^{115m}In}.}
   ...
   \hspace{-5pt}}%
     \subfloat{
        ...
        \subfigimg[width=0.485\textwidth]{\hspace{4.5cm}b)}{./figures/52mMn.pdf}{50}
         %         \refstepcounter{subfigure}
         \label{fig:temp_52mMn}
   \hspace{-5pt}}%
    \caption{a) Measured \ce{^{nat}Fe}(p,x)\ce{^{52}Mn} cross section, with \ce{^{56}Fe}(p,$\alpha$n)\ce{^{52}Mn}/\ce{^{54}Fe}(p,2pn)\ce{^{52}Mn} reaction channels visibly peaking at approximately \mbox{30 MeV}.   b) Measured \ce{^{nat}Fe}(p,x)\ce{^{52m}Mn} cross section, with the \ce{^{56}Fe}(p,$\alpha$n)\ce{^{52m}Mn}/\ce{^{54}Fe}(p,2pn)\ce{^{52m}Mn} reaction channels visibly peaking at approximately \mbox{30 MeV}.} 
...
\subsection{\ce{^{nat}Ti}(p,x)\ce{^{54, 56}}????? cross sections} 
