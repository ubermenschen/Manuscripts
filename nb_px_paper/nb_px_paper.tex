...
The irradiation was motivated by interest in the characterization of the \ce{^{93}Nb}(p,4n)\ce{^{90}Mo} reaction as a new dosimetry standard for intermediate-energy protons.
Through this, a set of 38 measurements of cross sections for the \ce{^{nat}Nb}(p,x) and  \ce{^{nat}Cu}(p,x) reactions between 40.34 - 89.74 MeV are presented in this work, as well as 5 independent measurements of isomer branching ratios.
The cross sections were measured using the well-characterized \ce{^{nat}Al}(p,x)\ce{^{22}Na}, \ce{^{nat}Al}(p,x)\ce{^{24}Na}, \ce{^{nat}Cu}(p,x)\ce{^{56}Co}, \ce{^{nat}Cu}(p,x)\ce{^{62}Zn}, and \ce{^{nat}Cu}(p,x)\ce{^{65}Zn} monitor reactions  for accurate proton fluence measurement, with all activities quantified using high-purity germanium spectroscopy.
The measured cross sections are shown to be in excellent agreement with  literature values, and have been measured with significantly less uncertainty than previous measurements, through the use of variance minimization techniques to reduce proton energy uncertainties.
This work reports the first measurements of the  \ce{^{nat}Nb}(p,x)\ce{^{82m}Rb} reaction, as well as the first measurement of the independent cross sections for    \ce{^{nat}Cu}(p,x)\ce{^{52\text{m}}Mn}, \ce{^{nat}Cu}(p,x)\ce{^{52\text{g}}Mn}, and \ce{^{nat}Nb}(p,x)\ce{^{85\text{g}}Y} in the 40 - 90 MeV region.
Comparisons against the reaction modeling codes EMPIRE and TALYS are used to explore the impact of pre-equilibrium particle emission in the reaction dynamics for 40 - 90 MeV \ce{^{nat}Nb}(p,x) and  \ce{^{nat}Cu}(p,x) reactions.
...
\comment{Should \enquote{intermediate-energy} be less than 200 MeV, or 100 MeV?  I find conflicting descriptions in the literature.\\Lee:  I believe that 60 MeV is considered as the transition point\\ Stephen: }
...
One significant obstacle to both high-fidelity measurements of production cross sections for emerging medical radionuclides, as well as conventional isotope production, is a lack of well-characterized  dosimetry standards.  
...
While work is needed to improve upon existing dosimetry data, the development of new reactions can expand the available range of options for the monitoring of charged particle beams.
...
Between the reaction's energetic threshold  and the end of its compound peak, the magnitude and shape of a monitor reaction's excitation function is rapidly changing with increasing incident particle energy, making it useful for assigning the incident particle energy bin in a thin irradiated target.
...
This is extremely valuable, as it allows the screening and minimization of systematic errors based on energy assignment, though this sensitivity to energy precludes their reliability as a beam current monitor.  
...
Based on the \ce{^{nat}Al}(p,x)\ce{^{24}Na}, \ce{^{nat}Cu}(p,x)\ce{^{62}Zn}, and \ce{^{nat}Cu}(p,x)\ce{^{65}Zn} monitor reactions used to determine the average fluence at each energy position (seen in \autoref{fig:fluence_plot}), a fluence of 202.2$\pm$5.4 nAh was calculated to be incident upon the target stack, which shows excellent agreement with the nominal fluence of 205.9 nAh based on IPF upstream current monitors.
...
In addition, as there exist a number of isomers with radioactive ground states in these mass regions,  independent measurements of isomer-to-ground-state branching ratios for \ce{^{52m/g}Mn},\ce{^{58m/g}Co},\ce{^{85m/g}Y},\ce{^{87m/g}Y}, and \ce{^{89m/g}Nb} were  extracted from these data as well, which are recorded in \autoref{tab:ibr_table}.
...
% 82mRb      & $2.39\pm0.18$           & \hrulefill              & \hrulefill              & \hrulefill              & \hrulefill              & \hrulefill              \\
% 83Sr       & $3.88\pm0.56$           & $4.63\pm0.34$           & $3.42\pm0.32$           & \hrulefill              & \hrulefill              & \hrulefill              \\
% 85cum Y    & $13.31\pm0.30$          & $7.28\pm0.44$           & $2.06\pm0.12$           & \hrulefill              & \hrulefill              & \hrulefill              \\
% 85gY       & $2.286\pm0.057$         & $2.010\pm0.150$         & $0.545\pm0.030$         & \hrulefill              & \hrulefill              & \hrulefill              \\
% 85mY       & $11.03\pm0.30$          & $5.27\pm0.42$           & $1.52\pm0.12$           & \hrulefill              & \hrulefill              & \hrulefill              \\
% 86Zr       & $12.25\pm0.32$          & $17.63\pm0.44$          & $18.86\pm0.43$          & $6.00\pm0.15$           & \hrulefill              & \hrulefill              \\
% 86Y        & $32.25\pm0.89$          & $40.30\pm1.07$          & $39.02\pm1.00$          & $13.22\pm0.34$          & \hrulefill              & \hrulefill              \\
...
% 89cum Nb   & \hrulefill              & \hrulefill              & $175.52\pm12.44$        & $208.99\pm4.33$         & \hrulefill              & \hrulefill              \\
% 89gNb      & \hrulefill              & \hrulefill              & $141.58\pm12.28$        & $181.73\pm4.08$         & \hrulefill              & \hrulefill              \\
% 89mNb      & \hrulefill              & \hrulefill              & $33.94\pm1.97$          & $27.26\pm1.45$          & \hrulefill              & \hrulefill              \\
...
% 91mNb      & \hrulefill              & \hrulefill              & \hrulefill              & \hrulefill              & \hrulefill              & $66.96\pm4.16$          \\
...
% 82mRb & $\sigma_c$ & $2.39\pm0.18$           & \hrulefill              & \hrulefill              & \hrulefill              & \hrulefill              & \hrulefill              \\
% 83Sr  & $\sigma_c$ & $3.88\pm0.56$           & $4.63\pm0.34$           & $3.42\pm0.32$           & \hrulefill              & \hrulefill              & \hrulefill              \\
% 85 Y  & $\sigma_c$ & $13.31\pm0.30$          & $7.28\pm0.44$           & $2.06\pm0.12$           & \hrulefill              & \hrulefill              & \hrulefill              \\
% 85gY  & $\sigma_i$ & $2.286\pm0.057$         & $2.010\pm0.150$         & $0.545\pm0.030$         & \hrulefill              & \hrulefill              & \hrulefill              \\
% 85mY  & $\sigma_i$ & $11.03\pm0.30$          & $5.27\pm0.42$           & $1.52\pm0.12$           & \hrulefill              & \hrulefill              & \hrulefill              \\
% 86Zr  & $\sigma_c$ & $12.25\pm0.32$          & $17.63\pm0.44$          & $18.86\pm0.43$          & $6.00\pm0.15$           & \hrulefill              & \hrulefill              \\
% 86Y   & $\sigma_c$ & $32.25\pm0.89$          & $40.30\pm1.07$          & $39.02\pm1.00$          & $13.22\pm0.34$          & \hrulefill              & \hrulefill              \\
...
% 89 Nb & $\sigma_c$ & \hrulefill              & \hrulefill              & $175.52\pm12.44$        & $208.99\pm4.33$         & \hrulefill              & \hrulefill              \\
% 89gNb & $\sigma_i$ & \hrulefill              & \hrulefill              & $141.58\pm12.28$        & $181.73\pm4.08$         & \hrulefill              & \hrulefill              \\
% 89mNb & $\sigma_i$ & \hrulefill              & \hrulefill              & $33.94\pm1.97$          & $27.26\pm1.45$          & \hrulefill              & \hrulefill              \\
...
% 91mNb & $\sigma_c$ & \hrulefill              & \hrulefill              & \hrulefill              & \hrulefill              & \hrulefill              & $66.96\pm4.16$          \\
...
\ce{^{51}Cr}\,($\sigma_c$)    & $0.888\pm0.058$         & $0.361\pm0.015$         & $0.440\pm0.019$         & $0.2949\pm0.0070$       & \hrulefill              & \hrulefill              \\
\ce{^{52}Mn}\,($\sigma_c$)    & $1.640\pm0.042$         & $0.552\pm0.014$         & $0.0398\pm0.0012$       & $0.00513\pm0.00051$     & \hrulefill              & \hrulefill              \\
\ce{^{52g}Mn}\,($\sigma_i$)   & $0.650\pm0.018$         & $0.231\pm0.013$         & $0.0160\pm0.0021$       & $0.000961\pm0.000027$   & \hrulefill              & \hrulefill              \\
\ce{^{52m}Mn}\,($\sigma_i$)   & $0.989\pm0.037$         & $0.321\pm0.020$         & $0.0238\pm0.0032$       & $0.00417\pm0.00043$     & \hrulefill              & \hrulefill              \\
\ce{^{54}Mn}\,($\sigma_c$)    & $5.67\pm0.15$           & $3.65\pm0.11$           & $4.05\pm0.11$           & $4.71\pm0.12$           & $1.656\pm0.042$         & \hrulefill              \\
\ce{^{55}Co}\,($\sigma_c$)    & $1.656\pm0.048$         & $0.983\pm0.030$         & $0.1892\pm0.0076$       & $0.0291\pm0.0024$       & $0.00231\pm0.00019$     & \hrulefill              \\
\ce{^{56}Ni}\,($\sigma_c$)    & $0.0779\pm0.0022$       & $0.0973\pm0.0025$       & $0.0886\pm0.0022$       & $0.02967\pm0.00079$     & \hrulefill              & \hrulefill              \\
...
E$_\text{p}$ (MeV)             & $89.74^{+0.48}_{-0.43}$ & $79.95^{+0.67}_{-0.64}$ & $70.17^{+0.91}_{-0.85}$ & $61.58^{+1.03}_{-0.98}$ & $52.10^{+1.25}_{-1.20}$ & $41.05^{+1.62}_{-1.54}$ \\ \midrule
\ce{^{nat}Cu}(p,x)\ce{^{52}Mn} & $0.603\pm0.027$         & $0.581\pm0.038$         & $0.598\pm0.083$         & $0.81\pm0.12$         & \hrulefill              & \hrulefill              \\
\ce{^{nat}Cu}(p,x)\ce{^{58}Co} & $0.757\pm0.068$         & $0.804\pm0.091$         & $0.858\pm0.084$         & $0.767\pm0.086$         & $0.82\pm0.11$         & $0.982\pm0.075$    \vspace{1em}     \\ 
E$_\text{p}$ (MeV)             & $89.37^{+0.47}_{-0.45}$ & $79.55^{+0.68}_{-0.64}$ & $69.70^{+0.90}_{-0.85}$ & $61.07^{+1.05}_{-0.98}$ & $51.51^{+1.25}_{-1.21}$ & $40.34^{+1.58}_{-1.55}$ \\ \midrule
\ce{^{nat}Nb}(p,x)\ce{^{85}Y}  & $0.828\pm0.029$         & $0.724\pm0.072$         & $0.736\pm0.072$         & \hrulefill              & \hrulefill              & \hrulefill              \\
\ce{^{nat}Nb}(p,x)\ce{^{87}Y}  & $0.746\pm0.045$         & $0.865\pm0.036$         & $0.893\pm0.032$         & $0.936\pm0.038$         & $0.961\pm0.032$         & $0.676\pm0.040$         \\
\ce{^{nat}Nb}(p,x)\ce{^{89}Nb} & \hrulefill              & \hrulefill              & $0.193\pm0.018$         & $0.1304\pm0.0074$         & \hrulefill              & \hrulefill              \\ \bottomrule
\end{tabular}
}
\end{table}
...
The various \ce{^{nat}Cu}(p,x) cross sections measured here are in excellent agreement with the body of measurements in the literature,  but have been measured nearly exclusively with the smallest uncertainties to date.
...
Not only do the \ce{^{nat}Nb}(p,x) measurements in this work fill in the sparse data in this energy region, but they have been measured with the smallest uncertainties of existing literature data.
...
We also present here the first measurement of the independent cross sections for    \ce{^{nat}Cu}(p,x)\ce{^{52\text{m}}Mn} ($2^+$) and  \ce{^{nat}Cu}(p,x)\ce{^{52\text{g}}Mn}  ($6^+$), as well as their  isomer branching ratio via \ce{^{nat}Cu}(p,x).  
The cumulative cross section from these data are consistent with existing measurements of the cumulative \ce{^{nat}Cu}(p,x)\ce{^{52}Mn} cross section.
Similarly, this work offers the first measurement of the independent cross sections for \ce{^{nat}Nb}(p,x)\ce{^{85\text{g}}Y},  as well as the first measurement of the     \ce{^{85\text{m}}Y} ($\sfrac{9}{2}^+$) / \ce{^{85\text{g}}Y}  ($t\sfrac{1}{2}^-$) isomer branching ratio via \ce{^{nat}Nb}(p,x).



Notably, this work serves as the most well-characterized measurement of the \ce{^{nat}Nb}(p,x)\ce{^{90}Mo} reaction below 100 MeV to date, with cross sections measured in this energy region at the 2-3\% uncertainty level.
...
In addition, \ce{^{90}Mo}  possesses seven strong, distinct gamma lines which are easily able to be used for the identification and quantification of produced \ce{^{90}Mo}.
Finally, the production of \ce{^{90}Mo}  in the 40 - 90 MeV region is well-fed, with a peak cross section of approximately 120 mb, which creates a strong signal for activity quantification.
While additional measurements are needed to improve the characterization of this excitation function, this clearly presents the first step towards the use of \ce{^{90}Mo} as a clean and precise monitor for charged particle dosimetry in irradiations up to approximately 24 hours in duration.
...
These include the non-standard PET emitters \ce{^{57}Ni},  \ce{^{86}Y}, \ce{^{89}Zr},  \ce{^{90}Nb}, the $\beta^-$-therapy agent  \ce{^{64}Cu},  and the Auger-therapy agent \ce{^{82\text{m}}Rb}. 



\ce{^{57}Ni} ($t_{1/2}=35.60\pm0.06$ h, $\epsilon$=100\% to \ce{^{57}Co} \cite{Bhat1998}), while useful on its own as a PET emitter, stands poised as a particularly promising candidate for theranostic pairing with the soft $\beta^-$ emitter \ce{^{66}Ni} ($t_{1/2}=54.6\pm0.3$ h, $\beta^-$=100\% to \ce{^{66}Cu} \cite{Browne2010a}) \cite{PMID:7632762,zweit1996medium,Graves2016,Rosch2014}. 
\ce{^{nat}Cu}(p,x)\ce{^{57}Ni} would seem to be an intriguing production pathway, due to the ready availability of Cu metal as target, combined with the fact that production in this pathway strongly favors \ce{^{57}Ni} over \ce{^{56}Ni} - indeed, the \ce{^{57}Ni}/\ce{^{56}Ni} ratio of cross sections is approximately 70 at 61.58 MeV, and varies from 11-18 at the 70-90 MeV positions.
...
\ce{^{86}Y} ($t_{1/2}=14.74\pm0.02$ h, $\epsilon$=100\% to \ce{^{86}Sr}  \cite{NEGRET20151}) is another novel  emerging  PET emitter, whose longer half-life has poised it for applications as a tracer for slower metabolic processes, as well as in   pharmacokinetics studies \cite{Nickles2003,Qaim2008,QaimSyedM2011}.
In particular, it is highly desired to form a theranostic pair with the widely-employed $\beta^-$ therapy agent \ce{^{90}Y} ($t_{1/2}=64.00\pm0.21$ h, $\beta^-$=100\% to \ce{^{90}Zr} \cite{Browne1997}), which emits no observable gamma rays or x-rays though decay, necessitating an imaging isotope to be paired with for quantification of its uptake and biodistribution  \cite{Herzog1993}.
Conventional production of \ce{^{86}Y} proceeds through low-energy (7 - 14 MeV) irradiation via \ce{^{86}Sr}(p,n), which requires an enriched  \ce{^{86}Sr} target (9.86\% natural abundance), lest it suffer contamination from (p,n) on the other stable \ce{^{84,87,88}Sr} isotopes  \cite{Rosch1993}.
...
Unfortunately, it would appear that \ce{^{nat}Nb}(p,x) is a poor route for  \ce{^{86}Y} production in this respect, as it only reaches a maximum of approximately 35\% of all radio-yttrium activities produced.
This is because the dominant radio-yttrium activity in 40-90 MeV \ce{^{nat}Nb}(p,x) is  \ce{^{87}Y}, the largest obstacle to high-specific activity production of  \ce{^{86}Y} due to the unnecessary patient dose it contributes,  its comparable half-life, and the single neutron difference making efficient separations nearly impossible. 
...
\ce{^{89}Zr} ($t_{1/2}=78.41\pm0.12$ h, $\epsilon$=100\% to \ce{^{89}Y}  \cite{Singh2013}) is a long-lived PET emitter, whose long lifetime makes it useful as a tracer for slow biological processes, immune studies, and imaging of liver and  breast cancers \cite{Verel2003,Dijkers2009,Dijkers2010}.
...
Due to co-production of additional \ce{^{86,87,88}Zr} radio-zirconium,  \ce{^{nat}Nb}(p,x) is clearly inferior to  \ce{^{89}Y}(p,n)\ce{^{89}Zr}, as the Nb route has a smaller peak cross section of approximately 290 mb, and achieves only 50 -75\% radio-zirconium purity in the 50 - 90 MeV region.




\ce{^{90}Nb} ($t_{1/2}=14.60 \pm 0.05$ h, $\epsilon$=100\% to \ce{^{90}Zr}  \cite{Browne1997}) is an emerging PET emitter with a moderate lifetime, making it suited for immune studies including tumor uptake studies    \cite{Busse2002,Radchenko2012}.
It is typically produced using 8 - 15 MeV protons via \ce{^{90}Zr}(p,n)\ce{^{89}Nb}, and requires an enriched target (51.45\% natural abundance), but produces a product with minimal contamination and a peak cross section of approximately 750 mb  \cite{Busse2002}.
...
\ce{^{90}Nb} may be produced directly with an approximately 360 mb peak cross section and 87\% radio-niobium purity, or could be produced as a \ce{^{90}Mo}/\ce{^{90}Nb} generator, which would have nearly 100\% radio-molybdenum purity by using protons below the \ce{^{nat}Nb}(p,5n) threshold.



Moving away from the potential PET emitters, \ce{^{64}Cu}  ($t_{1/2}$ = 12.7 h) undergoes $\beta^+$ decay (61.5\% branching ratio) to \ce{^{64}Ni} or $\beta^-$ decay (38.5\% branching ratio) to \ce{^{64}Zn} \cite{Singh2007}.
The emitted short-range 190-keV $\beta^-$ particle makes this an  attractive  therapeutic radionuclide, and the PET branch gives  \ce{^{64}Cu}  the possibility for real-time dose monitoring and verification.
This makes \ce{^{64}Cu} particularly desirable  for emerging radiation therapy protocols \cite{Lewis2003,Bandari2014,mp500671j}.
Several production routes currently exist: \ce{^{64}Ni}(p,n)  uses 8 - 14 MeV protons on the expensive enriched target \ce{^{64}Ni} (0.9255\% natural abundance), but offers a high radio-copper purity assuming a highly enriched target \cite{Szelecsenyi1993,Aslam2009}.
\ce{^{68}Zn}(p,$\alpha$n) requires more energetic 20 - 30 MeV protons, and necessitates an enriched target (18.45\% natural abundance), lest the various other radio-coppers contaminate \ce{^{64}Cu}  purity \cite{Hilgers2003a,Szelecsenyi2005}.
...
Finally, \ce{^{82\text{m}}Rb} ($t_{1/2}=6.472\pm0.006$ h, $\epsilon$=100\% to \ce{^{82}Kr}  \cite{Tuli2003}) is an emerging Auger-therapy agent, typically seen as a contaminant in \ce{^{82}Sr}/\ce{^{82}Rb} generators for PET studies \cite{Kovacs1991}.
...
In summation, we present here a set of 38 measurements of cross sections for the \ce{^{nat}Nb}(p,x) and  \ce{^{nat}Cu}(p,x) reactions between 40.34 - 89.74 MeV, as well as 5 independent measurements of isomer branching ratios.
Nearly all cross sections have been reported with smaller uncertainties than previous measurements, and we report the first measurements of the  \ce{^{nat}Nb}(p,x)\ce{^{82m}Rb} reaction, as well as the first measurement of the independent cross sections for    \ce{^{nat}Cu}(p,x)\ce{^{52\text{m}}Mn}, \ce{^{nat}Cu}(p,x)\ce{^{52\text{g}}Mn}, and \ce{^{nat}Nb}(p,x)\ce{^{85\text{g}}Y} in the 40 - 90 MeV region.
...
The  values for lifetime and gamma ray branching ratios  listed here were used in all calculations of measured cross sections \cite{Basunia2015,Firestone2007,Wang2017,Dong2015,Dong2014,JUNDE2008787,Junde2011,Bhat1998,Nesaraja2010,BAGLIN2002,Browne2013,Zuber20151,NICHOLS2012973,Singh2007,Browne2010,Tuli2003,McCutchan2015,Singh2014,NEGRET20151,Johnson2015,McCutchan2014,Singh2013,Browne1997,Baglin2013,Baglin2012,Baglin2011}. 
