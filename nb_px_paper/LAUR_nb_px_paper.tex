...
\author[2,1]{Lee A. Bernstein}


\author[3]{Eva R. Birnbaum}

\author[4]{Jonathan W. Engle}
% \ead{jwengle@wisc.edu}


\author[5]{Stephen A. Graves}

\author[6]{Toshihiko  Kawano}


\author[1]{Amanda M. Lewis}


\author[3]{Francois M. Nortier}

\affil[1]{Department of Nuclear Engineering, University of California, Berkeley,  Berkeley, CA 94720}
\affil[2]{Nuclear Science Division, Lawrence Berkeley National Laboratory,  Berkeley, CA 94720}
% \address[llnl]{Lawrence Livermore National Laboratory, Livermore CA, 94551 USA}
\affil[4]{Department of Medical Physics, University of Wisconsin -- Madison,  Madison, WI 53705}
\affil[3]{Isotope Production Facility, Chemistry Division, Los Alamos National Laboratory,  Los Alamos, NM 87544}
\affil[5]{Department of Radiation Oncology, University of Iowa,  Iowa City, IA 52242}
\affil[6]{Theoretical Division, Los Alamos National Laboratory,  Los Alamos, NM 87544}
...
% % \sep Copper\sep Aluminum \usepackage[margin=2.5cm]{geometry}% by courtesy of Mico
