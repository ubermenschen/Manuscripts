...
\author{Andrew S. Voyles\thanksref{e1,addr1}
        ...
        \and
        M. Shamsuzzoha Basunia\thanksref{addr2} %etc.
        \and
        Lee A. Bernstein\thanksref{addr1,addr2} %etc.
        \and
        Jonathan W. Engle\thanksref{addr3} %etc.
        \and
        Stephen A. Graves\thanksref{addr4} %etc.
        \and
        Eric F. Matthews\thanksref{addr1}
}
