...
% A total of 
34 excitation functions were measured for 4~\textless~$E_p$~\textless~55\,MeV, including the first measurement of the independent cross sections for \ce{^{nat}Fe}(p,x)\ce{^{49,51}Cr}, \ce{^{51,52m,52g,56}Mn}, and \ce{^{58m,58g}Co}.  
