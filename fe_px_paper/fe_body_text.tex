...
This work presents the first measurement of several observables in this energy region, including the first independent cross sections for      \ce{^{nat}Fe}(p,x)\ce{^{52m,g}Mn},   the first measurement of \ce{^{52\text{m}}Mn} ($2^+$) / \ce{^{52\text{g}}Mn}  ($6^+$)   isomer branching ratios via \ce{^{nat}Fe}(p,x),  and extends the \ce{^{nat}Fe}(p,x)\ce{^{52}Mn} excitation function down to the lowest energy to date. 
...
For the \ce{^{nat}Fe}(p,x)\ce{^{52}Mn} cross section, seen in Figure \autoref{fig:temp_52Mn},  the first peak is well-modeled by TALYS and TENDL, but  rises much more rapidly than the data would support above 50\,MeV.
...
% Likewise, 
Like \ce{^{51}Mn}, \ce{Fe}(p,x) offers an interesting production pathway for  \ce{^{52}Mn}.
...
this energy region, including the measurement of the  \ce{^{nat}Fe}(p,x)\ce{^{58m}Co} reactions in the 0--70\,MeV region, 
the independent cross sections for      \ce{^{nat}Fe}(p,x)\ce{^{58g}Co}, and \ce{^{58\text{m}}Co} ($5^+$) / \ce{^{58\text{g}}Co}  ($2^+$)  isomer branching ratios via \ce{^{nat}Fe}(p,x), seen in \autoref{fig:58Co_IBR}. 
...
Despite being weakly-fed, EMPIRE, CoH, and TALYS/TENDL all do an excellent job of reproducing earlier work and this measurement, for the \ce{^{nat}Fe}(p,x)\ce{^{58g}Co} reaction channel, as well as the strongly-fed \ce{^{nat}Fe}(p,x)\ce{^{56}Co} reaction.
This holds for both the shape and magnitude of each excitation function, though CoH overestimates the \ce{^{nat}Fe}(p,x)\ce{^{58g}Co} peak magnitude by approximately 30\%, despite matching the rising and falling edges of the curve.
However, for both the \ce{^{nat}Fe}(p,x)\ce{^{56,58g}Co} channels, ALICE underestimates the magnitude of the rising edge and compound peak by nearly 50\%, though it shows the best agreement of these codes with the magnitude of the pre-equilibrium tails for these channels.
Additionally, all codes fail to reproduce the magnitude of the \ce{^{nat}Fe}(p,x)\ce{^{58m}Co} peak by approximately 25\%, and completely fail to reproduce the pre-equilibrium tail for this channel, as measured in this work. 
% In 
...
Neither publication reports any discussion of this channel, nor do they detail the length of each irradiation, possibly suggesting that transient equilibrium from the \ce{^{51}Mn} decay precursor was either not considered, or mis-calculated \cite{Basunia2020}.
% was not considered. 
...
This radionuclide ($t_{1/2}=312.20~\pm~0.020$ d, $\epsilon$=100\% to \ce{^{54}Cr}\,\cite{Dong2014}) has a convenient half-life and strong cross section (peak of approximately 160\,mb near 40\,MeV).
...
As we reported previously, modeling of \ce{^{nat}Cu}(p,x) reactions is poor in this energy region, despite the relative ease of only two stable target isotopes in copper.
For \ce{^{60}Cu}, all codes fail to predict the magnitude and shape of the channel, and tend to place the peak approximately 5\,MeV lower than observed.
Similar behavior is observed in the strongly-fed \ce{^{61}Cu}, though not to the same degree --- the peak shift is approximately 3\,MeV, but the shape predictions are more physical, despite a suppression of the pre-equilibrium tail in  EMPIRE.
\ce{^{64}Cu} modeling appears to be the best of these channels, with all codes matching the overall shape, but only EMPIRE predicting the rapid rise and fall of the compound peak, compared to the smoother behavior of the other codes.
...
As with the other foils in this experiment, \ce{^{nat}Cu}(p,x)  has  yielded measurements of  a number of additional  medical  radionuclides,  including the non-standard positron emitters 
...
Perhaps due to the abundance of reaction data available, modeling of these channels is markedly improved  in comparison to the \ce{^{nat}Fe}(p,x) channels discussed previously.
For \ce{^{44m}Sc}, the shape of the excitation function is well-modeled by EMPIRE, CoH, TALYS, and TENDL, though all of these codes place the compound peak approximately 4\,MeV lower than observed.
...
The same modeling trend is observed for \ce{^{44m}Sc}, though no judgment can be made for the pre-equilibrium tail, due to a paucity of data above 50\,MeV.
This is reflected in the measured isomer branching ratios for \ce{^{44}Sc}, seen in \autoref{fig:44Sc_IBR}.
...
\ce{^{47}Sc}\,\cite{Muller2014,Deilami-nezhad2016}.
% and the Auger-therapy agent \ce{^{82\text{m}}Rb}\,\cite{Kovacs1991,Titarenko2011}. 
Production of \ce{^{44}Sc} offers no major advantages over established \ce{^{44}Ca}(p,n) / \ce{^{44}Ca}(d,2n) / \ce{^{45}Sc}(p,2n)\ce{^{44}Ti} $\xrightarrow[]{\epsilon}$ \ce{^{44}Sc} pathways, with the  lower yield and radioisotopic purity failing to justify the convenience of natural targets  via    \ce{^{nat}Ti}(p,x). 
...
However, \ce{^{nat}Ti}(p,x) is clearly no compelling alternative if high specific activity is required, due to the inability to avoid co-production of long-lived Sc radiocontaminants, even with prudent selection of a beam energy window.
