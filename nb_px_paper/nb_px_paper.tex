...
\textred{The \ce{^{nat}Al}(p,x)\ce{^{22}Na} and \ce{^{nat}Al}(p,x)\ce{^{24}Na}  monitor reactions  were excluded from proton fluence determination due to the production of \ce{^{22,24}Na} contamination by \ce{^{nat}Si}(p,x) activation of the silicone adhesive used for sealing foil packets.}}
...
Comparisons against the reaction modeling codes CoH$_3$, EMPIRE, and TALYS are used to explore the impact of pre-equilibrium particle emission in the reaction dynamics for 40--90 MeV \ce{^{nat}Nb}(p,x) and  \ce{^{nat}Cu}(p,x) reactions.
