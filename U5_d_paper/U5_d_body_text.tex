...
Since it is neither anthropogenic nor primordial in occurrence, \ce{^{236}Np} constitutes a reference standard for isotope dilution mass spectrometry with the function of improving accuracy and precision for the detection of common neptunium isotopes associated with nuclear energy applications.
...
However, the current  inventory of \ce{^{236g}Np} ($t_{1/2}$ = 1.53$\pm0.05\times10^5$\,y\,\cite{XXX}) is extremely limited, with the worldwide stockpile limited to 10's of \mmicro g of material. 
The existing U.S. inventory was produced at Argonne National Laboratory  in the mid-1980's,  via the reaction \ce{^{235}U}(d,n)\ce{^{236g}Np} using a 20\,MeV deuteron beam. 
No effort was made to optimize irradiation conditions to minimize co-production of  \ce{^{237}Np}  or to evaluate alternative production routes. 
As a result, the current \ce{^{236g}Np} stock contains approximately 20\% of \ce{^{237}Np} (atom \%) impurity, which negatively affects both the analytical uncertainty and detection limit for \ce{^{237}Np}. 
% It is not realistic to increase the purity of such an extremely small quantity of 236gNp using electromagnetic isotope separation techniques, since separation efficiencies are generally below 1\%. 
Since the small amount of remaining material is currently available only for use as an isotope dilution tracer for \ce{^{237}Np} determination in high-value samples, it is clear that a new supply of \ce{^{236g}Np} tracer is critical to meeting the needs of the applications community.
% that are part of US nonproliferation programs. 
% A new supply of 236gNp tracer is critical to meeting the needs of the US nonproliferation, safeguards, and nuclear forensics communities. 
In 2015, the U.S. Certified Reference Materials (CRM) committee's \ce{^{236g}Np} working group identified  an annual requirement of 10--20 \mmicro g / y, with a minimum 93.3 atom\% \ce{^{236g}Np} content. 
An exact knowledge of \ce{^{235}U}(d,x)\ce{^{235,236,237}Np} reaction cross sections and threshold energies leads to \ce{^{236g}Np}  production with maximal yield and isotopic purity. 
Therefore, as part of a larger campaign to address deficiencies in cross-cutting nuclear data needs, our group has measured the nuclear excitation functions of the radionuclides \ce{^{236}Np} from deuteron-induced reactions on highly-enriched \ce{^{235}U} (HEU) targets, using a new variant on the  stacked-target technique  with nickel and titanium monitor foils.

Further, \ce{^{236}Np} is an interesting odd-odd nucleus with a high-spin ground state ($J^\pi=(6^-)$\,\cite{XXX}), as well as a low-lying isomer resulting from an anti-parallel coupling configuration ($t_{1/2}$ = 22.5$\pm0.4$\,h, $E_x\approx70\,\text{keV}, J^\pi=1$\,\cite{XXX}).
From an isotope production perspective, \ce{^{236m}Np} is interesting, as it has a 50$\pm$3\% decay branch \cite{XXX} to \ce{^{236}Pu}, which is itself a valuable reference tracer for the quantitative assay of Pu isotopes.
In addition to its needs for isotope production,  this experiment  offers an opportunity to study the distribution of angular momentum in compound nuclear and direct pre-equilibrium reactions via observation of the \ce{^{236m}Np}  to \ce{^{236g}Np}    ratio.
...
Mention spin applications for isotope production:
