...
measured the   nuclear excitation functions of the radionuclides \ce{^{51}Mn},   \ce{^{52m}Mn}, and \ce{^{52g}Mn} from proton-induced reactions on natural iron.
...
% natural iron foils 
iron foils of natural isotopic abundance with titanium and copper monitor foils.
...
are in \autoref{tab:fe_stack_table} of Appendix \ref{sec:fe_stack_design}.
...
This model fails to reproduce the fluence loss seen in monitor foils, and predicts a significantly higher production of secondary protons not seen in the activation data.
