...
However, due to the short half-life ($t_{1/2}$ = 6.0 h) of and dwindling supplies of \ce{^{99m}Tc}, \ce{^{47}Sc} stands poised as a potential solution to this shortage, due to its longer half-life and multiple production pathways without the need for highly enriched uranium \cite{Browne2011}.
...
%$E_n$ = 2.7645 MeV + 0.0151 MeV / - 0.0219 MeV.
...
\ce{^{115m}In} \cite{Blachot2012} & 336.241                                                           & 45.9 $\pm$ 0.1      & 4.486 h    \\
...
\begin{figure}
 \centering
 \includegraphics[scale=0.58]{./figures/ex2.pdf}
 % fracplot.pdf: 372x295 pixel, 72dpi, 13.12x10.41 cm, bb=0 0 372 295
...
Using the ratio method described here, the cross sections for the \ce{^{47}Ti}(n,p)\ce{^{47}Sc} and \ce{^{64}Zn}(n,p)\ce{^{64}Cu} reactions have been calculated for incident neutron energy of $E_n$ =2.765$^{+0.015}_{-0.022}$ MeV.
...
\comment{Batch - in both figs 10 and 11, our value is hard to see, esp. in black and white...  How to improve this, since there are so many experimental sets? Bigger symbols (this makes the centroid harder to see)?  arrow pointing to it?  Circle it?}
          
\section{Conclusion}

Using activation methods on thin foils, the \ce{^{47}Ti}(n,p)\ce{^{47}Sc} and \ce{^{64}Zn}(n,p)\ce{^{64}Cu} production cross sections were measured for  2.765$^{+0.015}_{-0.022}$ MeV neutrons produced using the High Flux Neutron Generator (HFNG) at UC Berkeley.
...
\comment{Use correct fast neutron energy above}
