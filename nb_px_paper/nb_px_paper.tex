...
In the case of independent cross sections, a similar process was followed, instead regressing to the solutions to the Bateman equation:
\begin{equation}
...
After quantifying the cumulative EoB activities at the top of a mass chain, and all subsequent independent EoB activities, these would be later used to report the various cross sections for all observed reaction products and isomeric states. 
