...
% \textred{
Due to \ce{^{nat}Si}(p,x)\ce{^{22,24}Na} contamination  by  activation of the silicone adhesive used for sealing foil packets, the \ce{^{nat}Al}(p,x)\ce{^{22}Na} and \ce{^{nat}Al}(p,x)\ce{^{24}Na}  monitor reactions  were excluded from proton fluence determination.
% }
% \textred{
...
\begin{figure}
 ...
 \comment{Stephen: Half-width figure: Larger text and axes tick-marks would be nice. }
...
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.59]{a)}{./figures/before_minimization_plot.pdf}{50}
...
%         \includegraphics[scale=0.6]{./figures/391keV_curve2.png}
        \subfigimg[scale=0.59]{b)}{./figures/after_minimization_plot.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{113m}In}.}
         \refstepcounter{subfigure}\label{fig:after_minimization}
    \end{subfigure}%
    \caption{Results of variance minimization through enhancement of the effective areal density of the 6061 aluminum degraders by 2.52\%. A noticeable reduction of variance in measured proton fluence is seen,  particularly at the  rear stack positions.}
...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.59]{a)}{./figures/after_minimization_plot_alt.pdf}{80}
%         \caption{ Decay curve for the isomeric transition of \ce{^{115m}In}.}
...
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
%         \includegraphics[scale=0.6]{./figures/391keV_curve2.png}
        \subfigimg[scale=0.59]{b)}{./figures/after_subtraction_plot.pdf}{80}
%         \caption{ Decay curve for the isomeric transition of \ce{^{113m}In}.}
         \refstepcounter{subfigure}\label{fig:after_subtraction}
    \end{subfigure}%
    \caption{The \enquote{extra fluence} observed in the  \ce{^{nat}Al}(p,x)\ce{^{22}Na} and \ce{^{nat}Al}(p,x)\ce{^{24}Na} monitor channels is caused by activation through (n,x) reactions from the secondary neutron flux. By excluding these contaminated channels, the remaining 3 independent monitor reactions serve to minimize uncertainty in stack energy assignments and incident fluence.}
...
\ce{^{52m}Mn}\,($\sigma_c$)   & $0.989\pm0.037$         & $0.321\pm0.020$         & $0.0238\pm0.0032$       & $0.00417\pm0.00043$     & --\cmmnt{\hrulefill}              & --\cmmnt{\hrulefill}              \\
...
\ce{^{90}Nb} may be produced directly with an approximately 360 mb peak cross section and 99\% radioisotopic purity, or could be produced as a \ce{^{90}Mo}/\ce{^{90}Nb} generator, which would have nearly 100\% radioisotopic purity by using protons below the \ce{^{nat}Nb}(p,5n) threshold of 45.76 MeV.
...
\ce{^{68}Zn}(p,$\alpha$n) requires more energetic 20--30 MeV protons, and necessitates an enriched target (18.45\% natural abundance) to avoid the co-production of radio-copper impurities \cite{Hilgers2003a,Szelecsenyi2005}.
...
The reactions with independent cross sections were compared to calculations with the reaction modeling codes EMPIRE, TALYS, and CoH, run with the default settings. 
...
The default level density in EMPIRE is the Enhanced Generalized Superfluid Model (EGSM) which uses the Generalized Superfluid model below a critical energy, and Fermi Gas model above it.
% \cite{add_level_density_models_here}.
...
Only total channel residual cross sections with experimental data through the full rise and fall of the peak, that have only one reaction channel, and that are at least 1\% of the total reaction cross section are discussed in detail. 
Residual production cross sections that do not exhibit the full rise and fall of the peak, which is identified as the compound portion of the cross section, do not provide enough information to analyze the calculations.
Some residuals, such as \ce{^{88}Zr}, can be produced by multiple reaction channels, in this case by (p,$\alpha$2n) and by (p,2n4n). Both compound peaks are seen in the data and cannot be separated, so such residuals are not included in the detailed analysis.
Very small channels, with cross sections less than 1\% of the total reaction cross section are excluded because the modeling of their cross sections is sensitive  to that of the more dominant  channels.
There are three residual nuclei that meet all of the above criteria for which there is an independent measurement of the residual production cross section --- \ce{^{86}Y}, \ce{^{90}Mo}, and \ce{^{90}Nb}.
...
In all three channels, the TALYS, TENDL, and CoH calculations rise, peak, and fall at lower energies than the data, while EMPIRE calculates the peak at higher energies.
...
The \ce{^{90}Nb} production cross section exhibits a persistent \enquote{pre-equilibrium} tail that keeps the channel open  well after the compound cross section has fallen away. 
...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/51Cr.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{115m}In}.}
...
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
%         \includegraphics[scale=0.6]{./figures/391keV_curve2.png}
        \subfigimg[scale=0.465]{}{./figures/52gMn.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{113m}In}.}
...
%         \includegraphics[width=\textwidth]{./figures/target2.png}
        \subfigimg[scale=0.47]{}{./figures/54Mn.pdf}{50}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
    ...
    \end{subfigure}
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/55Co.pdf}{50}
%         \caption{ Decay curve for the $\beta^+$ decay of \ce{^{64}Cu}.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{./figures/target2.png}
        \subfigimg[scale=0.465]{}{./figures/56Ni.pdf}{50}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
    ...
    \end{subfigure}
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/57Co.pdf}{50}
%         \caption{ Decay curve for the $\beta^+$ decay of \ce{^{64}Cu}.}
...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/57Ni.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{115m}In}.}
...
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
%         \includegraphics[scale=0.6]{./figures/391keV_curve2.png}
        \subfigimg[scale=0.47]{}{./figures/58Co.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{113m}In}.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{./figures/target2.png}
        \subfigimg[scale=0.465]{}{./figures/59Fe.pdf}{50}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
    ...
    \end{subfigure}
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/60Co.pdf}{50}
%         \caption{ Decay curve for the $\beta^+$ decay of \ce{^{64}Cu}.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{./figures/target2.png}
        \subfigimg[scale=0.47]{}{./figures/61Cu.pdf}{50}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
    ...
    \end{subfigure}
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/64Cu.pdf}{50}
%         \caption{ Decay curve for the $\beta^+$ decay of \ce{^{64}Cu}.}
...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/82mRb.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{115m}In}.}
...
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
%         \includegraphics[scale=0.6]{./figures/391keV_curve2.png}
        \subfigimg[scale=0.47]{}{./figures/83Sr.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{113m}In}.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{./figures/target2.png}
        \subfigimg[scale=0.47]{}{./figures/85Y.pdf}{50}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
    ...
    \end{subfigure}
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/86Y.pdf}{50}
%         \caption{ Decay curve for the $\beta^+$ decay of \ce{^{64}Cu}.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{./figures/target2.png}
        \subfigimg[scale=0.47]{}{./figures/86Zr.pdf}{50}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
    ...
    \end{subfigure}
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/87Y.pdf}{50}
%         \caption{ Decay curve for the $\beta^+$ decay of \ce{^{64}Cu}.}
...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/87Zr.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{115m}In}.}
...
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
%         \includegraphics[scale=0.6]{./figures/391keV_curve2.png}
        \subfigimg[scale=0.47]{}{./figures/88Y.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{113m}In}.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{./figures/target2.png}
        \subfigimg[scale=0.47]{}{./figures/88Zr.pdf}{50}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
    ...
    \end{subfigure}
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/89Nb.pdf}{50}
%         \caption{ Decay curve for the $\beta^+$ decay of \ce{^{64}Cu}.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{./figures/target2.png}
        \subfigimg[scale=0.47]{}{./figures/89Zr.pdf}{50}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
    ...
    \end{subfigure}
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.465]{}{./figures/90Mo.pdf}{50}
%         \caption{ Decay curve for the $\beta^+$ decay of \ce{^{64}Cu}.}
...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/90Nb.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{115m}In}.}
...
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
%         \includegraphics[scale=0.6]{./figures/391keV_curve2.png}
        \subfigimg[scale=0.47]{}{./figures/91mNb.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{113m}In}.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{./figures/target2.png}
        \subfigimg[scale=0.47]{}{./figures/92mNb.pdf}{50}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
    ...
    \end{subfigure}
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/93mMo.pdf}{50}
%         \caption{ Decay curve for the $\beta^+$ decay of \ce{^{64}Cu}.}
...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/52Mn_IBR.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{115m}In}.}
...
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
%         \includegraphics[scale=0.6]{./figures/391keV_curve2.png}
        \subfigimg[scale=0.47]{}{./figures/58Co_IBR.pdf}{50}
%         \caption{ Decay curve for the isomeric transition of \ce{^{113m}In}.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{./figures/target2.png}
        \subfigimg[scale=0.47]{}{./figures/85Y_IBR.pdf}{50}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
    ...
    \end{subfigure}
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{./figures/Capture.PNG}
        \subfigimg[scale=0.47]{}{./figures/87Y_IBR.pdf}{50}
%         \caption{ Decay curve for the $\beta^+$ decay of \ce{^{64}Cu}.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{./figures/target2.png}
        \subfigimg[scale=0.47]{}{./figures/89Nb_IBR.pdf}{50}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
