...
\title{Excitation functions for (p,x) reactions of niobium (E\texorpdfstring{$_{\text{p}}$\,=\,40--90\,}{Ep = 40--90 }MeV):  development of the \ce{^{93}Nb}(p,4n)\ce{^{90}Mo} reaction as an intermediate-energy proton monitor}
