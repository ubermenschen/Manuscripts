...
Manganese radionuclides are desirable for radiopharmaceutical applications, as manganese is a chemically versatile element that is biologically relevant and essential in trace quantities. 
...
\ce{^{51}Cr}\,($\sigma_i$)&	\makecell{64.1\\$\pm$4.0} &	\makecell{75.7\\$\pm$3.3} &	\makecell{56.5\\$\pm$2.5} &	\makecell{27.6\\$\pm$1.3} &	\makecell{3.83\\$\pm$0.44} &	\makecell{0.90\\$\pm$0.12} &	\makecell{0.70\\$\pm$0.11} &	\makecell{0.150\\$\pm$0.026} &	\makecell{0.067\\$\pm$0.017} &	-- &	-- &	-- &	-- &	--\\
\ce{^{51}Cr}\,($\sigma_c$)&	\makecell{75.9\\$\pm$4.0} &	\makecell{91.3\\$\pm$3.3} &	\makecell{68.3\\$\pm$2.5} &	\makecell{33.7\\$\pm$1.3} &	\makecell{4.30\\$\pm$0.44} &	\makecell{1.582\\$\pm$0.071} &	\makecell{1.760\\$\pm$0.072} &	\makecell{2.117\\$\pm$0.079} &	\makecell{2.165\\$\pm$0.096} &	\makecell{1.981\\$\pm$0.063} &	\makecell{1.456\\$\pm$0.044} &	\makecell{0.584\\$\pm$0.025} &	-- &	--\\
...
Notably, this work is the most well-characterized measurement of the \ce{^{nat}Fe}(p,x)\ce{^{51,52}Mn} reaction below 70\,MeV to date, with cross sections measured  at the 4--9\% uncertainty level.
...
\textred{PLACEHOLDER TEXT -- }

\textred{Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse urna diam, bibendum eu venenatis sit amet, vulputate in mi. Sed elit ex, aliquet in pharetra efficitur, mattis vel odio. Donec a augue lectus. Vestibulum fermentum rutrum justo, non imperdiet risus iaculis vitae. Aliquam non quam nec dui scelerisque bibendum rhoncus sed tellus. Aenean fermentum ullamcorper turpis, et gravida diam feugiat a. Nam nec dignissim massa. Morbi ultrices at neque in eleifend. Duis non lobortis ipsum, sit amet lobortis nisl. In ultrices posuere volutpat. Nunc mattis libero porttitor tortor mollis, nec tincidunt lacus sollicitudin. Sed vulputate at justo quis sodales. Nulla risus lorem, pellentesque a mauris ornare, varius maximus nulla. Aliquam tempus blandit ex. Suspendisse quis imperdiet sapien, nec egestas magna. Nam eu molestie nibh.}
% 
% 
% 
% % In this work
...
\begin{tabular}{ c c c c}
 ...
 TALYS-1.8\cite{Koning2012}          & Koning-Delaroche & Specific folded potential\cite{Koning2012}      & Brink-Axel Lorentzian\cite{Koning2012}   \\
  ...
  ALICE-2017\cite{Blann1996}     &   \textred{?????}    &   \textred{?????}    &   \textred{?????}
