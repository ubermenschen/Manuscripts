...
The largest source of uncertainty in energy window arises from uncertainties in the actual dimension of the deuteron beam on the production target.
 We believe, based on \enquote{burn marks} on the deuteron production target, that the beam was approximately circular, with a flat intensity profile and a 5 mm diameter.
...
\begin{tabular}{@{}cc@{}}
\toprule
Reaction                                                                            & $\sigma$($E_n$ = 2.765$^{+0.015}_{-0.022}$ MeV) (mb)                                                                       \\ \midrule
