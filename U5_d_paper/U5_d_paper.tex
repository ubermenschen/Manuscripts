...
\author{Andrew S. Voyles\thanksref{e1,addr1}
        \and
        Michael ??? Fassbender\thanksref{addr2} %etc.
         \and
        M. Shamsuzzoha Basunia\thanksref{addr3} %etc.
        \and
        J. C. Batchelder\thanksref{addr1} %etc.
        \and
        Lee A. Bernstein\thanksref{addr1,addr3} %etc.
%         Amanda M. Lewis\thanksref{addr1} %etc.
        \and
        Andrew ??? Gaunt\thanksref{addr2} %etc.
        \and
        Susan ??? Hanson\thanksref{addr2} %etc.
        \and
        Jonathan T. Morrell\thanksref{addr1} %etc.
        \and
        Iain ??? May\thanksref{addr2} %etc.
        \and
        Melinda ??? Wren\thanksref{addr2} %etc.        
}
...
\institute{Department of Nuclear Engineering, University of California, Berkeley,  Berkeley, CA 94720, USA \label{addr1}
           \and
           Chemistry Division, Los Alamos National Laboratory,  Los Alamos, NM 87544, USA \label{addr2}
           \and
           Nuclear Science Division, Lawrence Berkeley National Laboratory,  Berkeley, CA 94720, USA \label{addr3}
}
