...
The \ce{^{64}Zn}(n,p)\ce{^{64}Cu} cross section for 2.765$^{+0.015}_{-0.022}$ MeV neutrons is reported as   46.415 $\pm$ 1.720 mb (relative to \ce{^{113}In})  or 49.315 $\pm$ 2.567 mb (relative to \ce{^{115}In}), and the \ce{^{47}Ti}(n,p)\ce{^{47}Sc} cross section is reported as 26.262 $\pm$  0.822 mb.
