...
% We are confident that it will interest your audience. 
...
% ,  and Alexander Springer\footnotemark[1].
...
\footnotetext[9]{E. Lamere, \emph{et. al.}, PRC 100.3 (2019):034614.}
\footnotetext[10]{A.S. Voyles, \emph{et. al.},  NIM B: 429, pp. 53–74, Aug. 2018, doi:10.1016/j.nimb.2018.05.028.}
...
The   most recent previous measurements of the \ce{^{nat}Fe}(p,x) reactions are generally by S.A. Graves, \emph{et. al.}\footnotemark[11], the most recent previous measurements of the \ce{^{nat}Cu}(p,x) reactions are generally from our earlier work\footnotemark[10], and the most recent previous measurements of the \ce{^{nat}Ti}(p,x) reactions are generally by E. Garrido, \emph{et. al.}\footnotemark[12].
...
% Md. Uddin of the Atomic Energy Research Establishment, Bangladesh (\url{md.shuzauddin@yahoo.com}), 
...
\footnotetext[11]{S.A. Graves, \emph{et. al.}, NIM B: 386, 44--53 (2016), doi:10.1016/j.nimb.2016.09.018}
\footnotetext[12]{E. Garrido, \emph{et. al.}, NIM B: 383 Supplement C, 191--212 (2016), doi:10.1016/j.nimb.2016.07.011}
