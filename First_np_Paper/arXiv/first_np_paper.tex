...
% \begin{figure}
%  \centering
% %  \includegraphics[width=\columnwidth]{IMG_20160531_183154957_HDR.jpg}
%  \includegraphics[scale=0.06]{IMG_20160531_183154957_HDR.jpg}
...
%         \includegraphics[height=3in]{Capture.PNG}
...
%     \begin{subfigure}[t]{0.4\textwidth}
%         \centering
% %         \includegraphics[width=\textwidth]{target2.png}
%         \includegraphics[height=2in]{target2.png}
...
%         \includegraphics[width=\textwidth]{target2.png}
%         \includegraphics[height=2in]{target2.png}
        \includegraphics[height=2in]{cutaway.png}
...
\begin{figure}
    \centering
%         \includegraphics[width=\columnwidth]{Capture.PNG}
        \includegraphics[height=2.5in]{holder.pdf}
...
%         \centering
% %         \includegraphics[width=\columnwidth]{Capture.PNG}
%         \includegraphics[height=2in]{foils.png}
...
%         \centering
% %         \includegraphics[width=\textwidth]{target2.png}
%         \includegraphics[height=2in]{holder.pdf}
...
%         \centering
% %         \includegraphics[width=\textwidth]{target2.png}
%         \includegraphics[height=2in]{IMG_20151103_113432563.jpg}
...
\multirows{3}*{\minitab[c]{$^\text{nat}$Zn}}      & \multirows{3}*{\minitab[c]{\textgreater 99.99\%}} & \multirows{3}*{\minitab[c]{\ce{^{64}Zn} (49.17\%) }} & \multirows{3}*{\minitab[c]{698.9}}                                                              &   1.03 \pm 0.01 &  9.93 \pm 0.14  & 0.538 \pm 0.005 \\
...
\multirows{2}*{\minitab[c]{$^\text{nat}$Ti}}      & \multirows{2}*{\minitab[c]{99.999\%   }} & \multirows{2}*{\minitab[c]{\ce{^{47}Ti} (7.44\%)   }} & \multirows{2}*{\minitab[c]{434.7}}                                                              &   1.16 \pm 0.02 &  9.93 \pm 0.04  & 0.337 \pm 0.005 \\

 
  &  & & &  1.15 \pm 0.02 & 9.94 \pm 0.03 & 0.337 \pm 0.005  \\  \hline


\multirows{5}*{\minitab[c]{$^\text{nat}$In}}      & \multirows{5}*{\minitab[c]{\textgreater 99.999\%}} & \multirows{5}*{\minitab[c]{\ce{^{113}In} (4.29\%),\\ \ce{^{115}In} (95.71\%)}} & \multirows{5}*{\minitab[c]{317.6}}                                                              & 0.49 \pm 0.02*  & 9.75 \pm 0.09* & 0.248 \pm 0.005* \\
...
\begin{figure}
 \centering
 \includegraphics[scale=0.6]{scatt_angle.pdf}
...
%  \includegraphics[trim = 0mm 0mm 2mm 0mm, clip,width=\columnwidth]{mcnp_vised2.png}
...
% \begin{figure}
%  \centering
%  \includegraphics[scale=0.6]{mcnp_flux.pdf}
...
\begin{figure}
 \centering
 \includegraphics[scale=0.6]{mcnp_flux_new.pdf}
 % mcnp_flux.pdf: 373x295 pixel, 72dpi, 13.16x10.41 cm, bb=0 0 373 295
...
% \begin{figure}
%  \centering
%  \includegraphics[scale=0.6]{fracplot.pdf}
...
\begin{figure}
 \centering
 \includegraphics[scale=0.6]{fracplot_new.pdf}
 % fracplot.pdf: 372x295 pixel, 72dpi, 13.12x10.41 cm, bb=0 0 372 295
...
%         \centering
% %         \includegraphics[width=\columnwidth]{Capture.PNG}
%         \includegraphics[height=2.8in]{IMG_20160531_182618557_HDR.jpg}
...
%         \centering
% %         \includegraphics[width=\textwidth]{target2.png}
%         \includegraphics[height=2.8in]{IMG_20160531_182635712_HDR.jpg}
...
\begin{figure*}[ht]
    ...
    \begin{subfigure}[t]{\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{Capture.PNG}
%         \includegraphics[width=5in]{ti_foils.png}
        \subfigimg[width=5in]{a)}{47sc_gspectrum_alt.pdf}
...
% 	\caption{}
    ...
    \begin{subfigure}[t]{\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{target2.png}
%         \includegraphics[width=5in]{Sample_spectra.png}
        \subfigimg[width=5in]{b)}{64Cu_gspectrum_alt.pdf}
...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{Capture.PNG}
        \subfigimg[scale=0.6]{a)}{336keV_curve_new.pdf}
%         \caption{ Decay curve for the isomeric transition of \ce{^{115m}In}.}
    ...
    \end{subfigure}%
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{Capture.PNG}
%         \includegraphics[scale=0.6]{391keV_curve2.png}
        \subfigimg[scale=0.6]{b)}{391keV_curve_new.pdf}
%         \caption{ Decay curve for the isomeric transition of \ce{^{113m}In}.}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\textwidth]{target2.png}
        \subfigimg[scale=0.6]{c)}{417keV_curve_new.pdf}
%         \caption{Decay curve for the $\beta^-$ decay of \ce{^{116}In}.}
    ...
    \end{subfigure}
     \begin{subfigure}[t]{0.49\textwidth}
        \centering
%         \includegraphics[width=\columnwidth]{Capture.PNG}
        \subfigimg[scale=0.6]{d)}{511keV_curve_new.pdf}
...
%                   S[table-format=+5.1,table-figures-uncertainty=1]|
%                   @{}}% \multicolumn{1}{c}{Reference Foil}                      & \ce{^{nat}In}         & \ce{^{nat}In}       & \ce{^{nat}In} & \ce{^{nat}In}     & \ce{^{nat}In}  \\ \hline
% Reference Foil                     & \multirows{1}*{\minitab[c]{$^\text{nat}$In}}         & \ce{^{nat}In}       & \ce{^{nat}In} & \ce{^{nat}In}     & \ce{^{nat}In}  \\ \hline
...
\begin{figure}
 \centering
 \includegraphics[scale=0.55]{fig1_cropped.pdf}
 % fracplot.pdf: 372x295 pixel, 72dpi, 13.12x10.41 cm, bb=0 0 372 295
...
Using the ratio method described, the cross sections for the \ce{^{47}Ti}(n,p)\ce{^{47}Sc} and \ce{^{64}Zn}(n,p)\ce{^{64}Cu} reactions have been calculated for incident neutron energy of $E_n$ =2.76$^{+0.01}_{-0.02}$ MeV.
...
\begin{tabular}{@{}cS[table-format=+2.1,
                  table-figures-uncertainty=1]@{}}
\toprule
Reaction                   & \multirows{1}*{\minitab[c]{$\sigma$($E_n$ = 2.76$^{+0.01}_{-0.02}$ MeV) (mb)}}       \\ \midrule
\multirows{3}*{\minitab[c]{\ce{^{64}Zn}(n,p)\ce{^{64}Cu} \\ (relative to \ce{^{113}In})}} & 49.9 \pm 3.2 \\ 
											& 49.2 \pm 2.7 \\ 
											& 49.0 \pm 2.5 \\  \\[0.1ex]  
\multirows{3}*{\minitab[c]{\ce{^{64}Zn}(n,p)\ce{^{64}Cu} \\ (relative to \ce{^{115}In})}} & 45.9 \pm 2.6 \\ 
											& 46.5 \pm 1.7 \\ 
											& 46.8 \pm 3.2  \\ \\[0.1ex]    
\multirows{2}*{\minitab[c]{\ce{^{47}Ti}(n,p)\ce{^{47}Sc} \\ (relative to \ce{^{115}In})}} & 25.9 \pm 1.2 \\ 
...
\begin{figure}
 \centering
 \includegraphics[scale=0.65]{47sc_fixed_1point.pdf}
...
% \begin{figure}
%  \centering
%  \includegraphics[scale=0.6]{64cu_fixed.pdf}
%  % 47Sc_fixed.pdf: 375x294 pixel, 72dpi, 13.23x10.37 cm, bb=0 0 375 294
...
\begin{figure}
 \centering
 \includegraphics[scale=0.65]{64cu_fixed_1point.pdf}
 % 47Sc_fixed.pdf: 375x294 pixel, 72dpi, 13.23x10.37 cm, bb=0 0 375 294
...
The results for the production of \ce{^{116}In} via the \ce{^{115}In}(n,$\gamma$) reaction was shown to be consistent with activation predominantly from the capture of fast neutrons, rather than from \enquote{room return} thermal neutrons.
...
The measured values of  26.26 $\pm$  0.82 mb and  49.3 $\pm$ 2.6 mb (relative to \ce{^{113}In}) or 46.4 $\pm$ 1.7 mb (relative to \ce{^{115}In}), respectively, are consistent with earlier experimental data and theoretical models, but have smaller uncertainties than previous measurements.
 ...
 In addition, the   production of the \ce{^{116}In}  via the \ce{^{115}In}(n,$\gamma$) reaction was close to the value one would expect given an incident neutron energy of 2.45 MeV.  
