...
The purpose of the present work is to explore the potential to use high-flux neutron generators to produce high-specific activity samples of radionuclides at the mCi level for local use in the application community. \comment{Karl:  \enquote{A comment, hopefully not too gratuitous at this point, could be inserted here to the effect that if the promise of plasma-based DD generators is ultimately borne out, not only is it anticipated that most hospitals could have their own source affordably, but that it would open up a whole new realm of very short lifetime medical isotopes.  Lee to be the arbiter of whether this is prudent or not.}}
...
\toprule
{Foils Used} & {Metal Purity}          & {Abundance (a/o)}                                                           & \minitab[c]{Foil Density \\ (mg/cm$^2$)} & {Thickness (mm)}                                                                                                         & {Diameter (mm)}                                                                                                           & {Mass (g)}                                                                                    \\ \midrule
 ...
 &  & & & 0.50 \pm 0.03* & 9.98 \pm 0.15*  & 0.248 \pm 0.005* \\
  ...
  &  & & & 0.49 \pm 0.03* & 9.96 \pm 0.10* &  0.241 \pm 0.005* \\
   ...
   &  & & & 0.53 \pm 0.06$^\dagger$ & 10.01 \pm 0.11$^\dagger$ & 0.247 \pm 0.005$^\dagger$\\
    ...
    &  & & & 0.50 \pm 0.02$^\dagger$ & 10.00 \pm 0.09$^\dagger$  & 0.248 \pm 0.005$^\dagger$ \\ \hline
...
\multirow{2}*{\minitab[c]{$^\text{nat}$Ti}}      & \multirow{2}*{\minitab[c]{99.999\%   }} & \multirow{2}*{\minitab[c]{\ce{^{47}Ti} (7.44\%)   }} & \multirow{2}*{\minitab[c]{434.7}}                                                              &   1.16 \pm 0.02 &  9.93 \pm 0.04  & 0.337 \pm 0.005 \\
  ...
  &  & & &  1.15 \pm 0.02 & 9.94 \pm 0.03 & 0.337 \pm 0.005  \\   \bottomrule
\end{tabular}%
}
\end{table*}
...
% 
% 
% $^\text{nat}$In      & \textgreater 99.999\% & \begin{tabular}[c]{@{}c@{}}\ce{^{113}In} (4.29\%),\\ \ce{^{115}In} (95.71\%)\end{tabular} & 365.5                                                            & \begin{tabular}{S[table-format=+1.2,
%    table-figures-uncertainty=1]}0.49 \pm 0.02* \\ 0.50 \pm 0.03* \\ 0.49 \pm 0.03* \\ 0.53 \pm 0.06$^\dagger$ \\ 0.50 \pm 0.02$^\dagger$\end{tabular} & \begin{tabular}{S[table-format=+1.2,
%    table-figures-uncertainty=1]}9.75 \pm 0.09* \\ 9.98 \pm 0.15* \\ 9.96 \pm 0.10* \\ 10.01 \pm 0.11$^\dagger$ \\ 10.00 \pm 0.09$^\dagger$\end{tabular} & \begin{tabular}{S[table-format=+1.3,
%    table-figures-uncertainty=1]}0.248 \pm 0.005* \\ 0.248 \pm 0.005* \\ 0.241 \pm 0.005* \\ 0.247 \pm 0.005$^\dagger$\\  0.248 \pm 0.005$^\dagger$\ \end{tabular} \\ \hline
%    
%    
%    
% $^\text{nat}$Zn      & \textgreater 99.99\%  & \ce{^{64}Zn} (49.17\%)                                                            & 714.1                                                            & \begin{tabular}{S[table-format=+1.2,
%    table-figures-uncertainty=1]}1.03 \pm 0.01 \\ 1.03 \pm 0.01 \\ 1.02 \pm 0.01\end{tabular}                                    & \begin{tabular}{S[table-format=+1.2,
%    table-figures-uncertainty=1]}9.93 \pm 0.14 \\ 9.76 \pm 0.17 \\ 9.89 \pm 0.15\end{tabular}                                     & \begin{tabular}{S[table-format=+1.3,
%    table-figures-uncertainty=1]}0.538 \pm 0.005 \\ 0.451 \pm 0.005 \\ 0.452 \pm 0.005\ \end{tabular}                           \\ \hline
% 
% 
% 
% $^\text{nat}$Ti      & 99.999\%              & \ce{^{47}Ti} (7.44\%)                                                             & 450.6                                                            & \begin{tabular}{S[table-format=+1.2,
%    table-figures-uncertainty=1]}1.16 \pm 0.02 \\ 1.15 \pm 0.02\end{tabular}                                                         &\begin{tabular}{S[table-format=+1.2,
%    table-figures-uncertainty=1]}9.93 \pm 0.04 \\ 9.94 \pm 0.03\end{tabular}                                                          & \begin{tabular}{S[table-format=+1.3,
%    table-figures-uncertainty=1]}0.337 \pm 0.005 \\ 0.337 \pm 0.005\ \end{tabular}                                   \\ \bottomrule
% \end{tabular}%
% }
% \end{table*}
...
% \begin{tabular}{@{}ccccccc@{}}
% \toprule
% Foils Used & Metal Purity          & Abundance (a/o)                                                           & \begin{tabular}[c]{@{}c@{}}Foil Density \\ (mg/cm$^2$)\end{tabular} & Thickness (mm)                                                                                                         & Diameter (mm)                                                                                                           & Mass (g, $\pm$ 5 mg)                                                                                    \\ \midrule
...
The spectra for the different samples were summed and the net peak areas were fitted using gf3, part of the RadWare analysis package from Oak Ridge National Laboratory   \cite{radford2000radware, Radford1995}.
...
Target Foil Mass (g)               & 0.538         & 0.451       & 0.452 & 0.337     & 0.337   \\ 
Irradiation Time, $t_1$ (s)           & 10800         & 10800       & 12629 & 11837     & 14254   \\ 
Start of Count, $t_2$ (s)             & 12585         & 26985       & 14919 & 101245    & 16644   \\ 
End of Count, $t_3$ (s)               & 103773        & 80993       & 68919 & 187669    & 110275   \\ 
Photopeak Counts, 336 keV (\ce{^{115m}In}) & 113665 $\pm$ 1490 & 74321 $\pm$ 275 & 39895 $\pm$ 201 & 2122 $\pm$ 55 & 55102 $\pm$ 268   \\ 
Photopeak Counts, 391 keV (\ce{^{113m}In}) & 3382 $\pm$ 171    & 860 $\pm$ 40    & 2545 $\pm$ 54 &    \hrulefill       &  \hrulefill      \\ 
Photopeak Counts, 511 keV (\ce{^{64}Cu})   & 16055 $\pm$ 643   & 12852 $\pm$ 118 & 24464 $\pm$ 159 &    \hrulefill       &   \hrulefill     \\ 
...
% \resizebox{\textwidth}{!}{%
% \begin{tabular}{@{}l|
%                   S[table-format=+5.1,table-figures-uncertainty=1]|
%                   S[table-format=+5.1,table-figures-uncertainty=1]|
%                   S[table-format=+5.1,table-figures-uncertainty=1]|
%                   S[table-format=+5.1,table-figures-uncertainty=1]|
%                   S[table-format=+5.1,table-figures-uncertainty=1]|
%                   @{}}% \multicolumn{1}{c}{Reference Foil}                      & \ce{^{nat}In}         & \ce{^{nat}In}       & \ce{^{nat}In} & \ce{^{nat}In}     & \ce{^{nat}In}  \\ \hline
% Reference Foil                     & \multirow{1}*{\minitab[c]{$^\text{nat}$In}}         & \ce{^{nat}In}       & \ce{^{nat}In} & \ce{^{nat}In}     & \ce{^{nat}In}  \\ \hline
...
With the exception of decay constants, which have negligible uncertainty compared to other sources of uncertainties in this work, each of the parameters in this model carries am uncertainty.
...
Using the ratio method described, the cross sections for the \ce{^{47}Ti}(n,p)\ce{^{47}Sc} and \ce{^{64}Zn}(n,p)\ce{^{64}Cu} reactions have been calculated for incident neutron energy of $E_n$ =2.765$^{+0.015}_{-0.022}$ MeV.
...
The weighted average of the measurements give   46.415 $\pm$ 1.720 mb (relative to \ce{^{113}In}) and  49.315 $\pm$ 2.567 mb (relative to \ce{^{115}In})    for \ce{^{64}Zn}(n,p)\ce{^{64}Cu},   and 26.262 $\pm$  0.822 mb for  \ce{^{47}Ti}(n,p)\ce{^{47}Sc}.
...
\comment{Karl: \enquote{You may wish to add a statement that this is a significant finding of this work.  It wasn't a foregone conclusion that it would work out this way, given the several order of magnitude difference in cross section.}}
...
An optimal design for the neutron generator would also allow for the possibility of reflecting fast neutrons back onto the target to maximize their utilization for radionuclide production.
 ...
 \comment{Karl: \enquote{Excellent paragraph. You may with to say that the HFNG is now operating at 10$^9$ n/sec, with a clear path towards 10$^{10}$, and a design study is underway for such a neutron-reflector assisted HFNG for actual medical isotope production.}}
...
Funding has been provided from the US Nuclear Regulatory Commission, the US Nuclear Data Program, \textcolor{red}{NSF ARRA Grant \# XXXXXXXX}, the University of California Laboratory Fees Research Grant \# 12-LR-238745, and  DFG Research Fellowship \# RU 2065/1-1.

\comment{Add NSF Grant number from P. Renne.}
 
We acknowledge Glenn Jones of G\&J Jones Enterprises of Dublin, CA for the construction and commissioning of the High Flux Neutron Generator. 
